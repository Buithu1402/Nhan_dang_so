...
def recognize_image():
    ...
    if original_image is not None:
        ...
        for i in contours:
            ...
            # Position the text to the left of the bounding box
            offset = 10  # Distance from the left side of the bounding box
            text_x = x - offset  # Position the text to the left of the bounding box
            text_y = y + h // 2  # Vertically centered within the bounding box
        ...
        tk.messagebox.showwarning("Warning", "Hãy tải ảnh trước khi nhận diện!")
